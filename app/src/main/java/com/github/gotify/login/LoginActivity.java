...
//        clientName.setWidth(320);
//
//        clientName.setText(Build.MODEL);

        View view = getLayoutInflater().inflate(R.layout.login_dialog_view, null);
        final EditText clientName = (EditText) view.findViewById(R.id.dialog_edit);
        clientName.setText(Build.MODEL);

        AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(this, R.style.AppTheme_Dialog))
